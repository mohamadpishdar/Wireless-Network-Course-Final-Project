...
public:
   ...
   */
uint32_t GetCurrentRate (uint32_t id);
   ...
   */
void setUidForIdeal(uint32_t id);
/**
*\in tabe vazifeye enteghal id rate feli az kelas ideal wifimanager be wifimanager
*\ro darad 
*/
...
void DoSetTxopThreshhold(Time txop1);
